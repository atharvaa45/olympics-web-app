...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\CHANDRA SHEKHAR\olympics-analysis-web-app'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\CHANDRA SHEKHAR\olympics-analysis-web-app\Scripts\deactivate.nu'
